...
export const siteConfig: SiteConfig = {
	...
	banner: {
		enable: true,
		src: "assets/images/ctf-banner.svg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "Writeups",
			url: "/archive/?category=CTF%20Writeups",
		},
		{
			name: "Bin Exp",
			url: "/archive/?category=Binary%20Exploitation",
		},
		{
			name: "Projects",
		...
		{
			name: "GitHub",
			url: "https://github.com/Rahulrajln1111", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://github.com/Rahulrajln1111",
		},
		{
			name: "LinkedIn",
